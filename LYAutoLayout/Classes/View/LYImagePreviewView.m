...
@implementation LYImagePreviewView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        // 页面控制
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frameHeight-40, MainWidth, 20)];
...
{
    _pageIndex = scrollView.contentOffset.x / self.frameWidth;
...
- (void)setImageUrl:(NSString *)imageUrl{
    _imageUrl = imageUrl;
    [self.imageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://m.easyyimin.com/%@",self.imageUrl]] placeholderImage:[UIImage imageNamed:@"photo"]];
}
